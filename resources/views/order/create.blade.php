        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <div class="row-fluid">
                        <form id="form-order" action="/orders/create" method="post">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <select class="selectpicker show-tick form-control" id="product-list" data-live-search="true" title="Nothing selected" data-size="5" required>
                                        @foreach($products as $item)
                                        <option value="{{$item->id}}" data-subtext="Stock: {{$item->stock}}" data-stock="{{$item->stock}}" data-name="{{$item->name}}" data-description="{{$item->description}}" data-price="{{$item->price}}">{{$item->name}} - {{$item->description}} - ${{$item->price}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-sm-2">
